define(['jquery', 'backbone', 'templates/jst', 'tools/navigate'],
    ...
    var advancedSearchViewEl = Backbone.View.extend({
        ...
        render: function() {
            this.$el.append(JST['src/js/templates/elements/search/advancedSearch.html']({
                apartmentAmenities: JST['src/js/templates/elements/options/optionsApartmentAmenities.html'](),
                communityAmenities: JST['src/js/templates/elements/options/optionsCommunityAmenities.html'](),
                petAmenities: JST['src/js/templates/elements/options/optionsPetAmenities.html'](),
                propertyTypesAmenities: JST['src/js/templates/elements/options/optionsPropertyTypesAmenities.html'](),
                photosVideosAmenities: JST['src/js/templates/elements/options/optionsPhotosVideosAmenities.html'](),
            }));
