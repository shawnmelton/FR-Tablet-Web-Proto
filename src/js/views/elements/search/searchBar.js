define(['jquery', 'backbone', 'templates/jst', 'tools/navigate', 'views/elements/search/advancedSearch'],
    ...
    var searchBarViewEl = Backbone.View.extend({
        ...
        render: function(heading) {
            this.parentEl.append(JST['src/js/templates/elements/search/searchBar.html']({
